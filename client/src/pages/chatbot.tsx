...
export default function CommunityChat() {
  ...
  useEffect(() => {
    if (JSON.stringify(messages) !== JSON.stringify(roomMessages)) {
      setMessages(roomMessages);
    }
  }, [roomMessages]);

  // Separate effect for auto-scrolling to prevent infinite loops
  useEffect(() => {
  ...
  return (
    ...
    <div className="flex-1 overflow-auto bg-gradient-to-br from-blue-50 via-white to-purple-50 transition-colors duration-200 pb-20 flex flex-col">
      {/* Header */}
      <header className="glass-effect sticky top-0 z-50">
        <div className="w-full max-w-4xl mx-auto px-2 py-1">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
                ...
                <SheetContent side="left" className="w-80 sm:w-72 p-0">
      ...
      <main className="w-full max-w-4xl mx-auto px-2 no-bottom-padding flex-1 flex flex-col">
        {/* Username Setup */}
        {!isUsernameSet && (
        ...
        {isUsernameSet && (
          <>
            ...
            {/* Chat Interface */}
            {selectedRoom ? (
              <div className="glass-effect rounded-lg mt-2 overflow-hidden flex-1 flex flex-col">
                <div className="p-2 flex-1 overflow-y-auto scroll-smooth" id="chat-container" style={{ maxHeight: 'calc(100vh - 200px)' }}>
                  <div className="compact-spacing">
                    {messages
      ...
      {isUsernameSet && selectedRoom && (
        <div className="fixed bottom-20 left-0 right-0 z-40 bg-white border-t border-gray-200 shadow-lg mt-auto">
